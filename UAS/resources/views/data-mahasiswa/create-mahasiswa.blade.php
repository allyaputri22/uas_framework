                    ...
                    <div class="container mx-auto mt-5">
                        ...
                        <form action="{{ route('mahasiswa-store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="prodi" name="prodi" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
